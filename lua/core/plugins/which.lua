local M = {
  ...
  config = function()
    ...
    wk.add({
      ...
      -- Group labels (individual keys defined in their respective plugin files)
      ...
      { "<leader>ln", "<cmd>lua vim.diagnostic.jump({ count = 1 })<cr>", desc = "Next Diagnostic" },
      { "<leader>lp", "<cmd>lua vim.diagnostic.jump({ count = -1 })<cr>", desc = "Prev Diagnostic" },
