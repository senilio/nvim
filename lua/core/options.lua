...
o.showtabline = 0 -- never show tab line (bufferline is used instead)
...
-- Colorscheme and highlight overrides live in lua/core/plugins/theme-github.lua
-- Terraform filetype detection lives in lua/core/autocmd.lua
