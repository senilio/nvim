-- kitty-pager.lua: invoked externally by Kitty as a pager via `--kitten` or
-- `scrollback_pager` config. Receives line/cursor position args from Kitty.
-- Not loaded by the normal Neovim plugin system.
